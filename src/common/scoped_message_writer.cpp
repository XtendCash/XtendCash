...
#define XTEND_INTEGRATION_TEST_HOOKS_IMPLEMENTATION
#include "common/xtend_integration_test_hooks.h"

// NOTE(xtend): This file only exists because I need a way to hook into the
...
// xtend_integration_test_hooks.h functions which isn't possible to expose in
